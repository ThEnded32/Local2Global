...
class Local2Global3DV3(pl.LightningModule):
    def __init__(
        self,
        epochs,
        in_channels=2,
        ...
        self.model = Local2GlobalUNet3Dv3() # model change made here
...
if __name__ == "__main__":
    ...
    # Training Epochs
    parser.add_argument("-e", "--epochs", dest="epochs", type=int, help="Epochs for trainings", default=200)
    # Batch Size
    ...
    ### Model and Training ###
    lighting_module = Local2Global3DV3(epochs)
